...
pub const STEWARD_CONFIG_MAINNET: &str = "jitoVjT9jRUyeXHzvCwzPgHj7yWNRhLcUoXtes4wtjv";
pub const STEWARD_CONFIG_TESTNET: &str = "5pZmpk3ktweGZW9xFknpEHhQoWeAKTzSGwnCUyVdiye";
